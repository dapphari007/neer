 ...
 * how long ago the data last changed, and what changed. It is only rendered
 * by the live build — a static export does not change, and a pulsing dot over
 * data that cannot move would be exactly the kind of decoration this product
 * exists to refuse.
 */
