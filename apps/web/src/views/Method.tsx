      ...
      <section style={{ marginTop: 26 }}>
        ...
        <div className="card" style={{ padding: 18, borderLeft: '3px solid var(--sev-watch)' }}>
          <ul style={{ fontSize: 13.5, lineHeight: 1.66, margin: 0, paddingLeft: 20 }}>
            ...
            <li>
              <strong>Citizen observations in this deployment are simulated.</strong> Weather and
              hydrology are real; the observations are generated by a documented physical model so
              the analytics can be exercised honestly. Nothing here describes any real stream.
            </li>
          </ul>
        </div>
      </section>
